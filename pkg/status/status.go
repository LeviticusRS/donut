...
var (
	...
	invalidCredentialsDescriptor     = message.Descriptor{Id: 3, Size: 0, Provider: message.Provide(InvalidCredentials)}
	accountDisabledDescriptor        = message.Descriptor{Id: 4, Size: 0, Provider: message.Provide(AccountDisabled)}
	alreadyLoggedInDescriptor        = message.Descriptor{Id: 5, Size: 0, Provider: message.Provide(AlreadyLoggedIn)}
	...
	loginLimitExceededDescriptor     = message.Descriptor{Id: 9, Size: 0, Provider: message.Provide(LoginLimitExceeded)}
	serverBeingUpdatedDescriptor     = message.Descriptor{Id: 14, Size: 0, Provider: message.Provide(ServerBeingUpdated)}
	worldRunningClosedBetaDescriptor = message.Descriptor{Id: 19, Size: 0, Provider: message.Provide(WorldRunningClosedBeta)}
	profileTransferDescriptor        = message.Descriptor{Id: 21, Size: 1, Provider: message.Provide(ProfileTransfer{})}
	malformedLoginPacketDescriptor   = message.Descriptor{Id: 22, Size: 0, Provider: message.Provide(MalformedLoginPacket)}
	errorLoadingProfileDescriptor    = message.Descriptor{Id: 24, Size: 0, Provider: message.Provide(ErrorLoadingProfile)}
	blockedComputerAddressDescriptor = message.Descriptor{Id: 26, Size: 0, Provider: message.Provide(BlockedComputerAddress)}
	serviceUnavailableDescriptor     = message.Descriptor{Id: 27, Size: 0, Provider: message.Provide(ServiceUnavailable)}
	customRejectionDescriptor        = message.Descriptor{Id: 29, Size: message.SizeVariableShort, Provider: message.Provide(CustomRejection{})}
	enterSixDigitDescriptor          = message.Descriptor{Id: 56, Size: 0, Provider: message.Provide(EnterSixDigitPinCode)}
	invalidSixDigitPinCodeDescriptor = message.Descriptor{Id: 57, Size: 0, Provider: message.Provide(InvalidSixDigitPinCode)}
...
func (unsupportedVersion) Decode(b *buffer.ByteBuffer, length int) error {
...
func (invalidCredentials) Decode(b *buffer.ByteBuffer, length int) error {
	return message.ErrDecodeNotSupported
}
...
func (accountDisabled) Decode(b *buffer.ByteBuffer, length int) error {
	return message.ErrDecodeNotSupported
}
...
func (alreadyLoggedIn) Decode(b *buffer.ByteBuffer, length int) error {
	return message.ErrDecodeNotSupported
}
...
func (loginLimitExceeded) Decode(b *buffer.ByteBuffer, length int) error {
	return message.ErrDecodeNotSupported
}
...
func (serverBeingUpdated) Decode(b *buffer.ByteBuffer, length int) error {
	return message.ErrDecodeNotSupported
}
...
func (ProfileTransfer) Decode(b *buffer.ByteBuffer, length int) error {
	return message.ErrDecodeNotSupported
}

func (msg ProfileTransfer) Encode(b *buffer.ByteBuffer) error {
	return b.PutUint8(msg.Delay)
}
...
func (worldRunningClosedBeta) Decode(b *buffer.ByteBuffer, length int) error {
	return message.ErrDecodeNotSupported
}
...
func (errorLoadingProfile) Decode(b *buffer.ByteBuffer, length int) error {
	return message.ErrDecodeNotSupported
}
...
func (blockedComputerAddress) Decode(b *buffer.ByteBuffer, length int) error {
	return message.ErrDecodeNotSupported
}
...
func (CustomRejection) Decode(b *buffer.ByteBuffer, length int) error {
	return message.ErrDecodeNotSupported
}

func (msg CustomRejection) Encode(b *buffer.ByteBuffer) error {
	_ = b.PutCString(msg.TopLabel)
	_ = b.PutCString(msg.CenterLabel)
	_ = b.PutCString(msg.BottomLabel)
...
func (enterSixDigitPinCode) Decode(b *buffer.ByteBuffer, length int) error {
	return message.ErrDecodeNotSupported
}
...
func (invalidSixDigitPinCode) Decode(b *buffer.ByteBuffer, length int) error {
	return message.ErrDecodeNotSupported
}
